...
- If your prism card is not claimed by the hostap_cs driver on insertion (see `dmesg` output, some cards are claimed by orinoco_cs) then view its device ids using `pccardctl ident`
